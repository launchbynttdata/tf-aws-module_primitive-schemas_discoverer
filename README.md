# tf-aws-module_primitive-schemas_discoverer
...
This Terraform module creates an [AWS EventBridge Schema Discoverer](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/schemas_discoverer) resource.
...
| Name | Type |
|------|------|
| [aws_schemas_discoverer.discoverer](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/schemas_discoverer) | resource |
...
| <a name="input_source_arn"></a> [source\_arn](#input\_source\_arn) | ARN of the event bus to associate with the schema discoverer. | `string` | n/a | yes |
